...
from controllers.abertura import listar_lockout, cadastrar_lockout, excluir_status_abertura, lista_status, envia_formulario_retirada, listar_lockouts, envia_formulario_devolucao
...
@valida_abertura_bp.route("/<tag>", methods=["GET"])
def visualizar_unico(tag):
        return listar_lockout(tag)
